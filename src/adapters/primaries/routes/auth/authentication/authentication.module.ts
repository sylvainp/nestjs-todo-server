...
import { EncryptionPortInjectorName } from '../../../../../domain/ports/encrypt.port';
...
import { BcryptAdapter } from '../../../../secondaries/encryption/bcrypt.adapter';
...
@Module({
  ...
  providers: [
    ...
    { provide: EncryptionPortInjectorName, useClass: BcryptAdapter },
  ],
